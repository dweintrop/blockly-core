...
CodeMirror.defineMode("turtle", function(config, parserConfig) {
  ...
  var keywords = function(){
    function kw(type, style) {return {type: type, style: "keyword"};}
    var A = kw("keyword a"), B = kw("keyword b"), C = kw("keyword c");
    var operator = kw("operator"), atom = {type: "atom", style: "atom"};

    var jsKeywords = {
      "if": kw("if"), "while": A, "with": A, "else": kw("else"), "do": B, "try": B, "finally": B,
  ...
  return {
    ...
    turtleToJS: function(inText) {
      var outText = inText + "out";
      return outText;
    },
