...
Textly.active_listener = null;

Textly.init = function() {
	Textly.active_listener = Textly.updatePrettyJS;
}
...
Textly.updatePrettyJSUpdate = function () {
	Textly.active_listener = Textly.updatePrettyJSUpdate;
	Textly.updatePrettyJS();
	var editablePrettyCodeDiv = new goog.editor.SeamlessField('textly-output');
...
Textly.updateXml = function () {
	Textly.active_listener = Textly.updateXml;
 ...
 * @private
 */
Textly.code.TABS_ = ['javascript', 'python', 'xml'];

Textly.code.selected = 'javascript';
